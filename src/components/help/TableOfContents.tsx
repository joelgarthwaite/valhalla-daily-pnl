...
const sections: TOCSection[] = [
  ...
  { id: 'microsoft-ads', title: 'Microsoft Ads', level: 1 },
  ...
  { id: 'inter-company', title: 'Inter-Company Transactions', level: 1 },
  { id: 'country-analysis', title: 'Country Analysis', level: 1 },
  { id: 'investor-metrics', title: 'Investor Metrics', level: 1 },
  { id: 'inventory-management', title: 'Inventory Management', level: 1 },
  { id: 'mobile-app', title: 'Mobile App (PWA)', level: 1 },
